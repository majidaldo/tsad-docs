...
%
\textsf{Weave} provides global network addressing for each container.
%
...
Before going into solution specifics, it should be noted that (at least traditional) high-performance computing facilities cannot satisfy these requirements.
%
mismatch
%
in summary, control.
%
rant about how hpc behind commodity
...
- last thing: usage instructions as in repo. this doc jsut high level more specifics in repo.
