...
\node (vagrant) {
  \begin{tikzpicture}[tikzcomputerpic]
    ...
    \begin{pgfonlayer}{background}
      \node[computer
      ,fit=(vagrantcomputenm) (vagstack)] (vagrantcomputebox) {};
    \end{pgfonlayer}
  \end{tikzpicture}
};
...
\node[left of=vagrant] (init) {
  \begin{tikzpicture}[tikzcomputerpic]
    ...
    \begin{pgfonlayer}{background}
      \node[computer,fit=(initnm) (initstack)] (initbox) {};
    \end{pgfonlayer}
  \end{tikzpicture}
};
...
\node[below of=vagrant] (local) {
  \begin{tikzpicture}[tikzcomputerpic]
    ...
    \begin{pgfonlayer}{background}
      \node[computer,fit=(localnm) (localstack)] (localbox) {};
    \end{pgfonlayer}
  \end{tikzpicture}
};
