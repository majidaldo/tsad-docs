...
%bold lines under purview direct,indirect of ansible automation todo
\begin{figure}[h]
\newcolumntype{T}{!{\vrule width 2pt}}
...
%todo: .... immatertial to discussion

%as go down. app rep less importnat
%influence of automation from btm up
