...
%todo: check the previous pdfs includegraphics
        \centering
        \includegraphics[]{figs/bo_spikelv.pdf}
        \caption{spike-1}
    \end{subfigure}%

  \begin{subfigure}[t]{\textwidth}
        \centering
        \includegraphics[]{figs/bo_spikereg.pdf}
        \caption{spike-2}
    \end{subfigure}%
...
Note the anomaly signal increases as soon as the sliding window (from the left) encounters the anomaly.
%
