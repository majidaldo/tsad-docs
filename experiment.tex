...
The optimized RNN has some expectation of the typical series.
%
...
Error calculations are presented graphically in Figure \ref{this} for each series.i
%todoref
%
...
\label{fig:err}
\caption{Anomaly scores of series} %todo: make tbls sentence case
\end{figure}
