...
%
The sliding window procedure, described in \ref{sec:adsample}, is used to get samples of some window width.
%
...
The \texttt{theanets} \cite{Johnson2015} implementation%
