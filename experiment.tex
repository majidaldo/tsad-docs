...
\begin{table}[H]
  ...
  {
    \ifthenelse{ \equal{\nm}{sin}}{   sine (gen.) }{}
    \ifthenelse{ \equal{\nm}{ecg}}{   ECG \cite{PhysioNet} }{}
    \ifthenelse{ \equal{\nm}{power}}{ power \cite{Keogh2005} }{}
    \ifthenelse{ \equal{\nm}{sleep}}{ sleep \cite{this} }{}
    \ifthenelse{ \equal{\nm}{spike}}{ spike (gen.) }{}
    & \ln & \mw & \ss & \wss & \bs & \ns
  }
...
%
After every optimization iteration, RNN parameters were saved.
%
The process was stopped until the best RNN, based on its validation loss, was subjectively able to detect anomalies.
